...
export function activate(context: vscode.ExtensionContext): void {
    ...
    const serverOptions: ServerOptions = {
        ...
        debug: { module: serverModuleDbg, transport: TransportKind.ipc, options: debugOptions },
    };
    ...
    const cl = new LanguageClient("HarbourServer", "Harbour Server", serverOptions, clientOptions);
